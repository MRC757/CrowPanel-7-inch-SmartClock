...
//   Temperature: 0 to 100 °F  (5 ticks: 0,25,50,75,100 — 25° steps)
...
inline lv_obj_t* ui_hourly_create()
{
    ...
    // Temperature: 0 to 100°F, 6 major ticks → 20° intervals
    _chart_temp = _make_hly_chart(scr, _HLY_ROW0_Y,
                                   lv_color_hex(0xff7043),
                                   0, 100, 6,
                                   _h_temp, &_ser_temp);
    _add_y_axis_labels(scr, _HLY_ROW0_Y + _HLY_LBL_H, 0, 100, 6, "\xB0");
    ...
    _hly_fill_temp = { _h_temp, 0, 100, 0xff7043 };
