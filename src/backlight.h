...
//
// The CrowPanel 7" backlight (V1.2/V1.3) is driven by the STC8H1K28 MCU at
// I2C address 0x30 which provides digital ON/OFF only (no hardware PWM).
// Brightness dimming is therefore achieved by scaling each RGB565 pixel in
// the LVGL disp_flush callback before pushing to the display.
//
// Usage (in disp_flush):
